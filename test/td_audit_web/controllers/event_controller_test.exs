defmodule TdAuditWeb.EventControllerTest do
  ...
  describe "GET /api/events" do
    ...
    @tag authenticated_user: @admin_user_name
    test "lists all events filtered by event type", %{conn: conn} do
    ...
    @tag authenticated_user: @admin_user_name
    test "lists all events filtered by range timestamp", %{conn: conn} do
    ...
    @tag authenticated_user: @admin_user_name
    test "lists all events filtered by start_ts", %{conn: conn} do
      insert(:event, event: "event_type_ts0", ts: "2021-02-01T00:00:00Z")
