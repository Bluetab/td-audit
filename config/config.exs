...
config :td_audit, TdAudit.Notifications.Email,
  ...
  subjects: [
    ...
    grant_request_approvals: "👓 Alert: Grant request approval decision",
    grant_request_group_creation: "⚡ Alert: New grant request",
    grant_request_status: "👓 Alert: Grant request status change",
    ...
    remediation_created: "📋 Alert: Remediation plan created",
  ...
  headers: [
    ...
    remediation_created: "The following remediation plan has been created",
